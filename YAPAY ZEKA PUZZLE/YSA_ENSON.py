...
class Network: 
    ...
    def __init__(self):
        ...
        """
        self.w1,self.w2,self.w3,self.w4,self.w5,self.w6,self.b1,self.b2,self.b3 = (3.728013348032361, -3.721684561106236, -1.0171800863440446, -2.0048311486333414, 9.072891765410846, 8.291436160819336, -1.995711310515916, -1.7723917930923117, -4.477056044091103)
    ...
    def train(self , data , labels):
        ...
        self.grafik_ciz(kayiplar)
        guncel_parametreler = (self.w1,self.w2,self.w3,self.w4,self.w5,self.w6,self.b1,self.b2,self.b3)
        print(guncel_parametreler)           
...
for a in range(a1*b1):
    for b in range(a1*b1):
        data.append([a,b])
        labels.append(int(a>b))
data = np.array(data)
labels = np.array(labels)
#numprint(data,labels)
